...
Coordinate system (x, y) chosen as:
    - x: row starting from 0 at the top of the input data.
         Range = (0, lines)
    - y: column starting from 0 at the left of the input data.
         Range = (0, line lenght)
'''
